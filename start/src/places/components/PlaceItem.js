  ...
  render() {
    return (
      <React.Fragment>
        ...
        footer={<Button danger onClick={this.closeMapHandler}>Close</Button>}
        >
          ...
          footer= {
            <React.Fragment>
              <Button inverse onClick={this.cancleDeleteHandler}>CANCLE</Button>
              <Button danger onClick={this.confirmDeleteHandler}>DELETE</Button>
            </React.Fragment>
          }
          >
            <p>
        ...
        <li>
          <Card className="place-item__content">
            ...
            <div className="place-item__actions">
              ...
              <Button danger onClick={this.showDeleteWarningHandler}>DELETE</Button>
            </div>
          </Card>
        </li>
      </React.Fragment>
